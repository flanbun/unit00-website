var serviceHost = "https://spotify.twinkiesnail.workers.dev";
var spotifyUser = "Paws";
        ...
        .then((data) => {
            if (data.hasOwnProperty("ERROR")) {
                document.getElementById(
                    "player-song"
                ).innerHTML = `${spotifyUser} isn't listening to anything right now!`;
            ...
            document.getElementById("player-status").innerHTML = data.is_playing
                ? `▶️ ${spotifyUser} is now listening to...`
